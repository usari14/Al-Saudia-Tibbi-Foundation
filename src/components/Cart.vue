<template>
    <div class="container mx-auto py-0 md:py-24 px-4">
        ...
        <div class="product text-center" v-for="(product, index) in products.slice(0, 1)" :key="index">
            <div class="flex flex-wrap py-10">
                <div
                    class="w-full md:w-7/12 flex flex-col md:flex-row gap-5 items-center md:items-start text-center md:text-left">
                    <div
                        class="flex items-center w-[182px] h-[183px] md:w-[102px] md:h-[103px] bg-white p-3 rounded-lg mx-auto md:mx-0">
                        <img :src="product.image" class="w-full h-full object-contain" alt="Product Image">
                    </div>
                    <div>
                        <h2 class="text-2xl md:text-[32px] font-medium leading-9 text-[#000000] mb-4 md:mb-1">{{
                            product.name }}</h2>
        ...
        <div class="flex justify-end  mb-5">
            <div class="w-[428px] h-[830px] bg-white border border-[#A7AAAB]">
                <p
                    class="bg-[#F5F5F5] w-full text-left py-6 pl-7 leading-10 text-[40px] font-medium border-b border-[#A7AAAB]">
                    Cart Total</p>
                <div class="px-8 py-10">
                    <div class="flex gap-8 md:gap-32 mb-5">
                        <p class="text-lg">Subtotal</p>
                        <span class="text-lg">Rs: 3000/-</span>
                    </div>
                    ...
                    <div class="flex gap-8 md:gap-32 mb-10">
                        ...
                        <div>
                            ...
                            <a href="/" class="px-7 py-2 bg-red-600 text-white rounded-sm text-lg font-semibold">Update</a>
                        </div>
                    </div>
                    <hr class="border- border-[#616161] mb-6">
                    <div class="flex gap-8 md:gap-32 mb-5">
                        <p class="text-lg">Total</p>
                        <span class="text-lg">Rs: 3300/-</span>
                    </div>
                    <hr class="border- border-[#616161] mb-6">
                    <router-link to="/checkout" class="bg-red-600 text-white px-10 py-3 w-full text-center block rounded-[4px]">Proceed to Checkout</router-link>
                </div>
