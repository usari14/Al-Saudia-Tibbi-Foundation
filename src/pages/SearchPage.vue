<template>
    <div class="flex flex-col items-center p-6">
      ...
      <div class="w-full max-w-xl mb-4">
        <input 
          v-model="searchQuery" 
          type="text" 
          placeholder="Enter something to search products"
      ...
      <!-- Display Products if Query is Provided -->
      <div v-else>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            >
              ...
              <router-link :to="{ path: `/productsdetails/${index}` }" class="block">
                <div class="w-[290px] h-auto bg-white shadow-lg rounded-lg overflow-hidden flex flex-col border border-gray-300">
  ...
  export default {
    ...
    methods: {
      addToCart(product) {
        // Handle Add to Cart functionality (you can add this logic later)
